...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Transaction History
						</h1>
                        ...
                        <div class="panel-body">
                             <div class="table-sorting table-responsive"id="printableArea">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "SELECT  distinct t.submitdate, t.paid,t.april,t.july,t.october,t.january, t.transaction_remark,
											s.sname,s.fname,s.admissionNo
									from fees_transaction as t join student as s on s.id = t.stdid";
...
$sql = "SELECT sum(paid) as tamount FROM fees_transaction where submitdate= '$date'";//total of each date
		$tpq = $conn->query($sql);
		$tpr = $tpq->fetch_assoc();
		$tamount = $tpr['tamount'];	
