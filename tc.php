...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">TRANSFER CERTIFICATE 
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Father Name</th><th>Class</th><th>Adm No</th><th>Total Fees</th><th>Balance</th><th>April Bal</th><th>July Bal</th><th>October Bal</th><th>January Bal</th><th>Action</th></tr></thead><tbody></tbody></table>');
			    ...
			    $("#tSortable22").dataTable({
                  ...
                  "bInfo": false,
							       'bProcessing' : true,
							       'bServerSide': true,
							       'sAjaxSource': "datatable.php?"+$('#searchform').serialize()+"&type=tc",
							       'aoColumnDefs': [{
                                   'bSortable': false,
...
////////////////////////////
 $("#tSortable22").dataTable({
                  ...
                  'bProcessing' : true,
				  'bServerSide': true,
                  'sAjaxSource': "datatable.php?type=tc",
