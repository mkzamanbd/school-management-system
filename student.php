...
$january = mysqli_real_escape_string($conn,$_POST['january']);
 ...
 if($_POST['action']=="add")	//student add
 {
 ...
 $q1 = $conn->query("INSERT INTO student (sname,fname,birthdate,admissionNo,roll_number,joindate,contact,about,emailid,branch,balance,fees,april,july,october,january,aprilb,julyb,octoberb,januaryb)
 VALUES ('$sname','$fname','$birthdate','$admissionNo','$roll_number','$joindate','$contact','$about','$emailid','$branch','$balance','$fees','$april','$july','$october','$january','$april','$july','$october','$january')") ;
...
echo '<script type="text/javascript">window.location="student.php?act=1";</script>';
  ...
  if($_POST['action']=="update")  //student update
 {

		$id = mysqli_real_escape_string($conn,$_POST['id']);
		$sql = "SELECT sum(paid) as totalpaid FROM fees_transaction WHERE stdid = '$id'";
		$tpq = $conn->query($sql);
		$tpr = $tpq->fetch_assoc();
		$totalpaid = $tpr['totalpaid'];
		$tbalance = $fees - $totalpaid;
	
	
	
   $sql = $conn->query("UPDATE student SET branch = '$branch', sname = '$sname',fname='$fname',birthdate='$birthdate',
   admissionNo ='$admissionNo',roll_number ='$roll_number',joindate='$joindate',
   contact = '$contact',about ='$about' ,emailid ='$emailid' WHERE id = '$id'");
...
if (mysqli_query($conn, $sql)) {
	...
	$sql = "DELETE FROM fees_transaction WHERE stdid='".$_GET['id']."'";
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="student.php" class="btn btn-primary btn-sm pull-right">Back <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="add_student.php" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Add </a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Mother Name* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="emailid" name="emailid" value="<?php echo $emailid;?>"  />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Date of Birth* </label>
								<div class="col-sm-10">
									<input type="date" class="form-control" id="birthdate" name="birthdate" value="<?php echo  date("Y-m-d", strtotime($birthdate));?>"  />
								</div>
							</div>
						...
						<fieldset class="scheduler-border" >
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Admission No* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="admissionNo" name="admissionNo" value="<?php echo $admissionNo;?>"  />
								</div>
							</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="roll_number" name="roll_number" value="<?php echo $roll_number;?>"  />
								</div>
							</div>	
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Admission Date </label>
								<div class="col-sm-10">
									<input type="date" class="form-control" id="joindate" name="joindate" value="<?php echo  ($joindate!='')?date("Y-m-d", strtotime($joindate)):'';?>" style="background-color: #fff;" readonly />
								</div>
							</div>
						 </fieldset>
					 ...
					 <div class="col-sm-12">
						...
						<div class="form-group col-sm-2">
									...
									<input type="text" class="form-control" id="april" name="april" value="<?php echo $april;?>"  />
						</div>
						
						<div class="form-group col-sm-2">
									<label>July Fees* </label>
									<input type="text" class="form-control" id="july" name="july" value="<?php echo $july;?>"  />	
						</div>
						
						<div class="form-group col-sm-2">
								<label >October Fees* </label>
								<input type="text" class="form-control" id="october" name="october" value="<?php echo $october;?>"  />
						</div>
						<div class="form-group col-sm-2">
								<label>January Fees* </label>
								<input type="text" class="form-control" id="january" name="january" value="<?php echo $january;?>"  />
						...
						?>
						 ...
						 <legend  class="scheduler-border">Optional Information:</legend>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password"> Student Address </label>
								<div class="col-sm-10">
                        ...
                        <div class="panel-body"id="printableArea">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "SELECT  distinct student.sname,student.fname,student.emailid,student.contact,
